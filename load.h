...
bool writedataout(vector<vector<Path> > route, double cost, vector<vector<double> > angle, int tabu_length, double total_time, double travelbest, double consistbest, double regionbest) 
{
...
bool writerecordout(double cost, int tabu_length, double total_time, double travelbest, double consistbest, double regionbest) 
{
	assert(abs(cost-travelbest-consistbest-regionbest)<EP);
	FILE *file;
